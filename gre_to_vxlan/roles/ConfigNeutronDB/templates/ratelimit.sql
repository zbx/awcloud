...
CREATE TABLE `ratelimit` (
  ...
  `interface` varchar(24) NOT NULL,
  `rl_type` varchar(24) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `port_id` (`port_id`),
  CONSTRAINT `ratelimit_ibfk_1` FOREIGN KEY (`port_id`) REFERENCES `ports` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2015-06-23 15:21:35
